...
export interface TemplateAdditionalProps extends TemplateProps<KcContext, I18n> {
  bgImg?: string;
...
export default function Template(props: TemplateAdditionalProps) {
  const {
    displayInfo = false,
    displayMessage = true,
  ...
  return (
    <>
      <div className={getClassName("kcLoginClass")}>
        ...
        <div style={{ width: bgImgWidth }}>
          <img src={bgImg} width={"100%"} height={bgImgHeight} />
        </div>
      </div>
    </>
  );
